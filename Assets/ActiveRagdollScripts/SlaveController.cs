...
public class SlaveController : MonoBehaviour
{
    ...
    [SerializeField] private float looseStrengthLerp = 1.0f;
    [SerializeField] private float gainStrengthLerp = 0.05f;
    [SerializeField] private float minContactForce = 0.1f;
    [SerializeField] private float minContactTorque = 0.1f;
    [SerializeField] private float deadTime = 4.0f;
