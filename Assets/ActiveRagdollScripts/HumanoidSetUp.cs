...
public class HumanoidSetUp : MonoBehaviour
{
    ...
    [NonSerialized] public MasterController masterController;
    [NonSerialized] public SlaveController slaveController;
    [NonSerialized] public AnimationFollowing animFollow;
    ...
    void Awake()
    {
        ...
        if (masterController == null) Debug.LogError("MasterController not found.");
