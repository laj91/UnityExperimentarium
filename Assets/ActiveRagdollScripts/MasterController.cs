...
public class MasterController : MonoBehaviour
{
    ...
    [SerializeField] private float pushBackSpeed = 7.0f;
    [SerializeField] private float maxPossibleDistanceFromRagdoll = 2.0f;
    ...
    void FixedUpdate()
    {
        ...
        MoveCharacter(pushBackMovement);
    ...
    private void MoveCharacter(Vector3 pushBackMovement)
    {
        switch (state)
        {
